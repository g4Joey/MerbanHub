...
public class SecurityConfig {
    ...
    SecurityFilterChain publicApi(HttpSecurity http) throws Exception {
        http
            .securityMatcher("/auth/**", "/api/auth/**", "/api/public/**", "/swagger-ui/**", "/v3/api-docs/**")
    ...
    @Bean
    @Order(2)
    SecurityFilterChain protectedApi(HttpSecurity http, JwtAuthFilter jwtAuthFilter) throws Exception {
        http
            .securityMatcher("/**")
            .csrf(csrf -> csrf.disable())
            .sessionManagement(sm -> sm.sessionCreationPolicy(SessionCreationPolicy.STATELESS))
    ...
    // ... rest of the beans stay the same ...
    @Bean
