              ...
              <div className="flex items-start space-x-3 flex-1">
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="font-semibold text-lg mb-2 truncate">
                    {result.name || result.fileName || "Untitled"}
                  </h3>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
                    ...
                    <div className="flex items-center space-x-2 text-sm text-muted-foreground">
                      ...
                      <span>
                        {result.fundDate ? formatDate(result.fundDate) : ""}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-wrap items-center gap-4 mb-4">
                    ...
                    <div className="flex items-center space-x-1 text-xs text-muted-foreground">
                      ...
                      <span>
                        {formatFileSize(result.size || result.fileSize || 0)}
                      </span>
                    </div>
                    <div className="flex items-center space-x-1 text-xs text-muted-foreground">
                      ...
                      <span>
                        ...
                        {result.ocrConfidence !== undefined
                          ...
                          : result.ocrConfidenceMin !== undefined
                          ? result.ocrConfidenceMin
                          : ""}
                        %
                      </span>
                    </div>
                    <Badge className={getStatusColor(result.indexStatus)}>
                      {result.indexStatus ? result.indexStatus : ""}
                    </Badge>
                  </div>
